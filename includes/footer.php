        ...
        <footer class="bg-dark text-light py-4 mt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h5>FarmApp</h5>
                        <p>Livestock management made simple.</p>
                    </div>
                    <div class="col-md-3">
                        <h5>Quick Links</h5>
                        <ul class="list-unstyled">
                            <li><a href="index.php" class="text-light">Home</a></li>
                            <li><a href="animal_list.php" class="text-light">Animals</a></li>
                            <li><a href="report_inventory.php" class="text-light">Reports</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3">
                        <h5>Help</h5>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="mb-0">&copy; <?= date('Y') ?> FarmApp. All rights reserved.</p>
                    </div>
